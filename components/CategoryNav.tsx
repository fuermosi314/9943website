...
export default function CategoryNav({ activeCategory, onCategoryChange }: CategoryNavProps) {
  ...
  return (
    <nav className="sticky top-16 z-40 bg-black/30 backdrop-blur-xl border-b border-white/10">
        ...
        <div className="flex items-center space-x-2 overflow-x-auto py-3 scrollbar-hide">
          {categories.map((category, index) => (
            <button
              ...
              className={`flex items-center px-4 py-3 rounded-full text-sm font-medium whitespace-nowrap transition-all duration-200 ${
