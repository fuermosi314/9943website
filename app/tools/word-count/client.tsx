            ...
            <div className="md:col-span-2">
              <div className="glass-card p-6">
                ...
                <textarea
                  ...
                  className="w-full min-h-48 h-64 sm:h-96 px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-[#fb6400] transition-all resize-none"
                />
              </div>
            </div>
          </div>
